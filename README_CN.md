...
也可以使用 Github Action 构建的 Tauri 桌面版本，具体见 [Github Action 构建 Tauri 桌面版本](https://github.com/NaeNaeTart/NaeNae-AMLL-TTML-TOOL/actions/workflows/build-desktop.yaml)。
