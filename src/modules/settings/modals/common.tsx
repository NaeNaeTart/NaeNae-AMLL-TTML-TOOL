		...
		<Flex direction="column" gap="4">
								...
								<Box flexGrow="1">
									<Flex gap="2" align="center" justify="between">
										<Flex direction="column" gap="1">
											<Text>
												{t(
													"settings.common.editActiveLineHighlight",
													"Highlight active line in Edit mode",
												)}
											</Text>
											<Text size="1" color="gray">
												{t(
													"settings.common.editActiveLineHighlightDesc",
													"Display a visual rail indicator for the currently playing active line while editing.",
												)}
											</Text>
										</Flex>
										<Switch
			...
			{section === "editor" && (
				<Flex direction="column" gap="3">
					...
					<Card
						style={{
							opacity: syncAutoScroll ? 1 : 0.4,
							transition: "opacity 0.2s ease",
							pointerEvents: syncAutoScroll ? "auto" : "none",
						}}
					>
						<Text as="label">
							<Flex gap="3" align="center">
								...
								<Box flexGrow="1">
									<Flex gap="2" align="center" justify="between">
										<Flex direction="column" gap="1">
											<Text
												style={{
													color: syncAutoScroll ? undefined : "var(--gray-9)",
												}}
											>
												{t(
										...
										<Flex direction="column" gap="1">
											<Text>
												{t(
													...
													"Auto-Scroll to Active Line in Edit Mode",
												)}
											</Text>
											<Text size="1" color="gray">
												{t(
													"settings.common.editAutoScrollDesc",
													"Automatically scrolls the editor view to follow the currently active lyric line during playback in the Edit tab.",
												)}
											</Text>
										</Flex>
										<Switch
										...
										<Flex direction="column" gap="1">
											<Text>
												{t(
													...
													"Auto-Scroll to Active Line in Timing Overview",
												)}
											</Text>
											<Text size="1" color="gray">
												{t(
													"settings.common.timingOverviewAutoScrollDesc",
													"Automatically scrolls the list to follow the currently active lyric line during playback in the Timing Overview tab.",
												)}
											</Text>
										</Flex>
										<Switch
